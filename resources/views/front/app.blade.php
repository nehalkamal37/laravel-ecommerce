            ...
            <div class="container-fluid-lg">
                <div class="row">
                    <div class="col-lg-12">
                       ...
                       <li><a href="index.htm" class="nav-link menu-title">{{__('Home')}}</a></li>
...
<!--  -->
                                                ...
                                                <li>
                                                 ...
                                                 <li>
                                                    <form action={{ route('logout')}} method="post">
                                                        @csrf
                                                    <button  class="btn default-theme  ">logout</button>
              ...
              <a  class="btn   " href="{{ route('dashboard.home')}}">Dahboard</a>
