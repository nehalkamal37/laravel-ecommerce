                ...
                <div class="col-xl-2 col-lg-2 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <span class="background-text">{{ $pro->category->name}}</span>
                            <div class="label-block">
                                <span class="label label-theme">30% Off</span>
                            </div>
                            <div class="cart-wrap">
                                <ul>
                                    <form action={{route('carts.index')}} method='post'>
                                        @csrf
                                        <input type="hidden" name="product_id" value="{{$pro->id}}">
                                    <li>
                  <button type="submit" href="javascript:void(0)" class="addtocart-btn">add</button>
                        ...
                        <div class="product-style-3 product-style-chair">
                            <div class="product-title d-block mb-0">
                                <div class="r-price">
                                    <div class="theme-color">${{$pro->price}}</div>
...
@endforeach
    ...
    <section class="category-section ratio_40">
        <div class="container-fluid">
                ...
                <div class="col-xxl-2 col-lg-3">
                    <div class="category-wrap category-padding category-block theme-bg-color">
                        <div>
                            ...
                            <h2 class="top-spacing">sub title</h2>
         ...
         <img src="{{ asset('uploads/category/'.$cat->category_image)}}" height="333px" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                                    <h3 class="theme-color">{{$cat->name}}</h3>
                                    <span class="text-dark">{{$cat->subtitle}}</span>
                                </div>
                            </a>
                        </div>
